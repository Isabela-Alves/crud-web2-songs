<script setup>
    ...
    const fechar = () =>{
        form.reset();
        document.querySelector('#fechar'+props.op).click();
    };
</script>
<template>
    <div class="modal fade" :id="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form @submit.prevent="(op === '1' ? save() : update())">
                    ...
                    <div class="input-group mb-3">
                        ...
                        name="title" v-model="form.title" maxlength="120" placeholder="Musica"
                        required></TextInput>
                    </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-dark" type="submit" :id="'fechar'+op" 
